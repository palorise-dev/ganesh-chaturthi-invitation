...
const content = {
  en: {
    ...
    sthapanaCopy: "With devotion, love and joy, we welcome Bappa into our home.",
    aarti: "आरती",
    aartiSub: "Aarti",
  ...
  mr: {
    ...
    sthapanaCopy: "भक्ती, प्रेम आणि आनंदाने आम्ही बाप्पांचे आमच्या घरी स्वागत करतो.",
    aarti: "आरती",
    aartiSub: "आरती",
  ...
  hi: {
    ...
    sthapanaCopy: "भक्ति, प्रेम और आनंद के साथ हम बप्पा का अपने घर में स्वागत करते हैं।",
    aarti: "आरती",
    aartiSub: "आरती",
...
export default function Home() {
  ...
  const openInvitation = () => {
    setOpened(true);
    window.setTimeout(() => {
      document.querySelector(".hero-scene")?.scrollIntoView({ behavior: "smooth" });
    }, 80);
  };
  ...
  return (
    <main>
      ...
      <div className={`open-screen ${opened ? "open-screen-hidden" : ""}`} role="dialog" aria-modal="true" aria-label="Open invitation" aria-hidden={opened}>
          ...
          <div className="open-card">
            ...
            <div className="open-mantra">{c.mantra.split("\n").map((line) => <span key={line}>{line}</span>)}</div>
            <button className="tap-open" onClick={openInvitation}>{c.open}</button>
      ...
      <div className="top-controls">
        <div className="language-switcher" aria-label="Language">
          {[
            ...
            <button key={key} className={lang === key ? "active" : ""} onClick={() => setLang(key)} aria-pressed={lang === key}>
              {label}
            </button>
          ))}
        </div>
      ...
      <section className="scene hero-scene">
        ...
        <div className="toran" aria-hidden="true"><i /><i /><i /><i /><i /><i /><i /></div>
        <div className="hero-copy">
          <div className="om-mark">ॐ</div>
          <p className="invocation">{c.invocation}</p>
          <h1>{c.heroTitle}</h1>
          <div className="hero-mantra">{c.mantra.split("\n").map((line) => <span key={line}>{line}</span>)}</div>
        </div>
        <Bappa src="/images/enhanced/bappa-hero.webp" alt="Traditional Ganesh murti" className="hero-bappa" />
        <div className="altar-floor" />
        <div className="diya diya-left"><span /></div>
        <div className="diya diya-right"><span /></div>
        <Petals count={12} />
        <div className="scroll-cue">{c.enter} <span>↓</span></div>
      </section>
      ...
      <section ref={welcomeRef} className="scene welcome-scene reveal">
        ...
        <div className="welcome-layout">
          ...
          <div className="portrait-stage">
            ...
            <Bappa src="/images/enhanced/bappa-welcome.webp" alt="Close view of the Ganesh murti" />
      ...
      <section ref={sthapanaRef} className="scene sthapana-scene reveal">
        ...
        <div className="sthapana-layout">
          <div className="sthapana-art">
            <div className="rangoli" aria-hidden="true"><span>ॐ</span></div>
            <Bappa src="/images/enhanced/bappa-hero.webp" alt="Ganesh murti at the family celebration" />
            <div className="altar-diyas"><div className="diya"><span /></div><div className="diya"><span /></div></div>
          </div>
          <div className="event-copy">
            <p className="devanagari">{c.sthapana}</p>
            <h2>Sthapana</h2>
      ...
      <section ref={bhaktiRef} className="scene bhakti-scene reveal">
        ...
        <div className="bhakti-layout">
          <div className="bhakti-copy">
            ...
            <p className="devanagari large">{c.aarti}</p>
            <h2>{c.aartiSub}</h2>
            <div className="time-list"><div><span>01</span><strong>{c.afternoon}</strong></div><div><span>02</span><strong>{c.night}</strong></div></div>
            <p className="small-copy">A quiet moment of prayer, gratitude and Bappa’s blessings.</p>
            <div className="morya bhakti-morya">{c.morya}</div>
          </div>
          <div className="aarti-visual">
            <div className="aarti-halo" aria-hidden="true" />
            <Bappa src="/images/enhanced/bappa-aarti.webp" alt="Close-up of Bappa during the devotional moment" />
            <div className="incense" aria-hidden="true"><i /><i /><i /></div>
            <div className="aarti-diya aarti-diya-left"><div className="diya"><span /></div></div>
            <div className="aarti-diya aarti-diya-right"><div className="diya"><span /></div></div>
          </div>
        </div>
      </section>
      ...
      <section ref={anandRef} className="scene anand-scene reveal">
        <FestivalLights className="section-lights" />
        <div className="light-string" aria-hidden="true">{Array.from({ length: 11 }).map((_, i) => <span key={i} />)}</div>
        <div className="anand-layout">
          <div className="anand-copy">
            ...
            <p>{c.karaokeCopy}</p>
            <div className="music-notes" aria-hidden="true">♪ ♫ ♪</div>
            <div className="morya">{c.morya}</div>
          </div>
          <div className="family-window">
            <div className="window-glow" />
            <div className="window-arch" aria-hidden="true" />
            <div className="bappa-mini"><img src="/images/enhanced/bappa-hero.webp" alt="" /></div>
            <div className="home-lamps"><div className="diya"><span /></div><div className="diya"><span /></div><div className="diya"><span /></div></div>
          </div>
        </div>
      </section>
      ...
      <section ref={visarjanRef} className="scene visarjan-scene reveal">
        ...
        <div className="water"><span /><span /><span /><span /></div>
        <FestivalLights className="visarjan-lights" />
        <div className="visarjan-copy">
          <p className="devanagari large">{c.visarjan}</p>
          <h2>{c.visarjanSub}</h2>
        ...
        <div className="visarjan-bappa">
          ...
          <img src="/images/enhanced/bappa-welcome.webp" alt="Ganesh murti at farewell" />
        </div>
      ...
      <footer className="closing">
        ...
        <div className="closing-line">रिद्धी * सिद्धी * शुभ * लाभ * क्षेम * मंगल * श्री</div>
      </footer>
    </main>
  );
}
